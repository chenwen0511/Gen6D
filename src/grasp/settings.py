...
GRASP_LED_TOP_UP_MM = _env_float(
    "GENPOSE2_GRASP_LED_TOP_UP_MM",
    "GRASP_LED_TOP_UP_MM",
    default=_cfg_float(_grasp, "led_top_up_mm", 24.5),
)
GRASP_LED_BOTTOM_UP_MM = _env_float(
    "GENPOSE2_GRASP_LED_BOTTOM_UP_MM",
    "GRASP_LED_BOTTOM_UP_MM",
    default=_cfg_float(_grasp, "led_bottom_up_mm", 30.0),
)
...
PLACE_SAM3_MASK_THRESHOLD = _env_float(
    ...
    default=_cfg_float(_place, "sam3_mask_threshold", 0.5),
)
PLACE_SAM3_TIMEOUT_S = _env_float(
    "GENPOSE2_PLACE_SAM3_TIMEOUT_S",
    default=_cfg_float(_place, "sam3_timeout_s", 300.0),
)
PLACE_DEPTH_OFFSET_MM = _env_float(
    "GENPOSE2_PLACE_DEPTH_OFFSET_MM",
    default=_cfg_float(_place, "depth_offset_mm", 100.0),
)
PLACE_HEIGHT_OFFSET_MM = _env_float(
    "GENPOSE2_PLACE_HEIGHT_OFFSET_MM",
    default=_cfg_float(_place, "height_offset_mm", 60.0),
)
...
DEFAULT_GRASP_LED_TOP_UP_MM = GRASP_LED_TOP_UP_MM
DEFAULT_GRASP_LED_BOTTOM_UP_MM = GRASP_LED_BOTTOM_UP_MM
...
DEFAULT_PLACE_SAM3_TIMEOUT_S = PLACE_SAM3_TIMEOUT_S
DEFAULT_PLACE_DEPTH_OFFSET_MM = PLACE_DEPTH_OFFSET_MM
DEFAULT_PLACE_HEIGHT_OFFSET_MM = PLACE_HEIGHT_OFFSET_MM
